...
fun EditTaskDialog(
    ...
    AlertDialog(
        ...
        confirmButton = {
            TextButton(onClick = {
                when {
                    title.isBlank() -> Toast.makeText(context, "Please enter task title", Toast.LENGTH_SHORT).show()
                    description.isBlank() -> Toast.makeText(context, "Please enter task description", Toast.LENGTH_SHORT).show()
                    else -> {
